...
set title "PSD (History)"
set xlabel "frequency index"
set ylabel "Power"
set logscale xy

plot "processed_1.dat" using 1 w l,\
	"processed_1.dat" using 2 w l,\
	"processed_1.dat" using 3 w l,\
	"processed_1.dat" using 4 w l,\
	"processed_1.dat" using 5 w l,\
