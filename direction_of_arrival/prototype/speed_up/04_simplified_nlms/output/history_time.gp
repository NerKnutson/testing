...
set title "Time  (History)"
set xlabel "Time index"
set ylabel "Power"

plot "time_data_1.dat" using 1 w l,\
	"time_data_1.dat" using 2 w l,\
	"time_data_1.dat" using 3 w l,\
	"time_data_1.dat" using 4 w l,\
	"time_data_1.dat" using 5 w l,\
